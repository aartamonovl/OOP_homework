...
public class GeoTree implements Reserch, Show, SaveToFile, LoadFromFile {
    ...
    @Override
    public void view(Person person, Relationship re, ArrayList<Person> persons){
        System.out.printf("%s %s:", re, person.getFullName());
        for (Person p: persons){
            System.out.printf("%s, ", p.getFullName());
        }
    }
